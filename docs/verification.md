...
| Tokenized assets/equities | Provenance-filtered 30d spot-volume sum, disjoint category snapshot, and top covered assets | Tokens.xyz curated RWA/stocks/ETF/metals lists | Snapshot cards/category breakdown/top-assets table; timeline after 8 genuine observations | Coverage/provenance, category reconciliation, ranking, subset, and snapshot-retention invariants |
