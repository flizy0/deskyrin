...
| Tokenized assets/equities | Non-stable RWA sum + Stocks subset | RWA.xyz embedded Solana data | Cards/chart/report | Semantic assertion + subset invariant |
...
| Interactive static dashboard | Vite + Chart.js | Fetches `/data.json` | 10 hover/keyboard-accessible charts and contained sortable tables | Production build; reproducible Playwright suite |
